...
public class ServerThread implements Runnable {
    //đại diện cho người dùng hiện đang kết nối thông qua luồng này.
    private User user;
    //đại diện cho kết nối giữa máy khách và máy chủ.
    private Socket socketOfServer;
    //Số thứ tự của máy khách, dùng để xác định máy khách nào đang kết nối thông qua luồng này.
    private int clientNumber;
    // dùng để đọc dữ liệu từ máy khách qua kết nối socket.
    private BufferedReader is;
    // dùng để ghi dữ liệu trả về máy khách qua kết nối socket.
    private BufferedWriter os;
    //Biến boolean để kiểm tra xem luồng này đã bị đóng hay chưa.
    private boolean isClosed;
    // đại diện cho phòng mà người dùng hiện đang tham gia.
    private Room room;
