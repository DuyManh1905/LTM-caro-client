...
public class Room {
    ...
    //Trả về ID của đối thủ (người chơi khác) dựa trên số thứ tự của máy khách (ID_ClientNumber)
    ...
    // Được sử dụng để cập nhật trạng thái của người chơi trong phòng thành "đang chơi" 
    // hoặc "không chơi" trong cơ sở dữ liệu thông qua đối tượng UserDAO.
